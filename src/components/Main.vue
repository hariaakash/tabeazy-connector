  ...
  <main class="dark:bg-gray-800 font-mono bg-white relative overflow-hidden h-screen">
      <header class="h-24 sm:h-32 flex items-center z-30 w-full">
          <div class="container mx-auto px-6 flex items-center justify-between">
              <div @click="openExternalUrl('mailto:support@tabeazy.com')" class="uppercase text-gray-800 dark:text-white font-black text-3xl flex items-center">
              ...
              <div class="flex items-center">
                  <nav class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden">
                      <a @click="openExternalUrl('https://seller.tabeazy.com')" class="py-2 px-6 flex hover:text-black">
                          Home
                      </a>
                      <a @click="openExternalUrl('https://tabeazy.com')" class="py-2 px-6 flex hover:text-black">
                          Store
                      </a>
                      <a @click="openExternalUrl('https://seller.tabeazy.com/support')" class="py-2 px-6 flex hover:text-black">
                          Support
                      </a>
                  </nav>
      ...
      <div class="flex relative z-20 items-center">
          <div class="container mx-auto px-6 flex flex-col justify-between items-center relative py-4">
              <div class="flex flex-col">
                  <img src="https://res.cloudinary.com/tabeazy/image/upload/f_auto,q_100,f_auto,h_100,c_fill/v1616145730/logo/logo_primary_text_dark_gxwb9a.png" class="w-56 mx-auto"/>
                  <p class="text-4xl my-6 text-center dark:text-white pt-10" v-if="company">
                      Hi, <span class="uppercase">{{ company }}</span> seller
                  </p>
                  <p class="text-3xl text-center dark:text-white py-6">
                      Welcome to Tabeazy Connector!
                  </p>
                  <h2 class="max-w-3xl text-5xl md:text-2xl font-bold mx-auto dark:text-white text-gray-800 text-center py-2 pt-10">
                      {{ currentAction.message }}
                  </h2>
                  <div class="flex items-center justify-center mt-3" v-if="currentAction.button">
                      <a @click="triggerAction()" class="uppercase py-2 my-2 px-4 md:mt-10 bg-transparent dark:text-gray-800 dark:bg-white hover:dark:bg-gray-100 border-2 border-gray-800 text-gray-800 dark:text-white hover:bg-gray-800 hover:text-white text-md">
...
export default {
  ...
  methods: {
    ...
    async startConnector() {
      ...
      const checkForSettingsIntegrity = await ipcRenderer.invoke('checkForSettingsIntegrity');
